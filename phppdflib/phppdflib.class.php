...
/*
   ...
   $Id: phppdflib.class.php,v 2.9 2004/03/24 14:26:14 wmoran Exp $
   
   adaption Hartleitner 2017.12.29 - Text will be encoded to 'ISO-8859-1'
*/
 ...
 ******************************************************/
    ...
    function draw_text($left, $bottom, $text, $parent, $attrib = array())
    {
        ...
        $n["left"] = $left;
        $n["bottom"] = $bottom;
        $n["text"] = mb_convert_encoding($text,'ISO-8859-1');
        $n["parent"] = $parent;
